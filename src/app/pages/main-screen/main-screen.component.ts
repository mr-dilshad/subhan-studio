...
@Component({
  ...
  standalone: true,
  imports: [CopyrightComponent, FooterComponent, TestimonialComponent, AboutTeamComponent, QuotesComponent, ProjectsComponent, ServicesComponent, BusinessVideoComponent, AboutComponent, FeaturesComponent, CarouselComponent, NavbarComponent, TopbarComponent, SpinnerComponent],
